...
/**
 * Servlet implementation class NegativeMarkServlet
 */
@WebServlet("/NegativeMarkServlet/*")
public class NegativeMarkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NegativeMarkServlet() {
        super();
...
String id1 = request.getPathInfo().substring(1);
		...
		if (ur1 == null){
			errorMsg = " ";
			urh.addMark(ur);
			ch.changeRate(c, "negative");
		}
		else{
			System.out.println("vec se ocijenilo!");
