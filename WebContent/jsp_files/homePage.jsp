...
<body onload="load()">
	...
	<ul>
		...
		<li>
			<% if (((User)request.getSession().getAttribute("loggedUser")).getBlocked() == false) {%>
				...
				<tbody id="tbody">
					<c:forEach items="${sessionScope.snippets}" var="item">
						<tr style="text-align:left">
							...
							<td width="60px">	
								<c:if test="${sessionScope.loggedUser.username == item.user.username }">
	...
	<div id="updateProfile" class="container" style="display: none">
		...
		<div class="container">
			<div class="my-panel vertical-center" id="upload">
				<form style="white-space: nowrap;" name="form1" action="/Project/UpdateServlet" method="POST" onsubmit="return validate(this)">
					<fieldset>
